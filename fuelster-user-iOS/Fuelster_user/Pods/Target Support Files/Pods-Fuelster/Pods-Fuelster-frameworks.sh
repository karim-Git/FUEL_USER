...
if [[ "$CONFIGURATION" == "Debug-Testing" ]]; then
  install_framework "Pods-Fuelster/Flurry_iOS_SDK.framework"
  install_framework "Pods-Fuelster/SDWebImage.framework"
  install_framework "Pods-Fuelster/Stripe.framework"
fi
